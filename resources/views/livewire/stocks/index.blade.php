<div class="py-12" x-data="{
    ...
    <x-data-table>
        ...
        <x-slot:tbBody>
            @forelse ($stocks as $index => $stock)
                <tr>
                    ...
                    <td class="border-dashed border-t border-gray-200">
                        ...
                        @else
                            <input type="text"
                                wire:model.defer="stocks.{{ $index }}.name_stock"
                    ...
                    <td class="border-dashed border-t border-gray-200">
                        ...
                        @else
                            <input type="number"
                                wire:model.defer="stocks.{{ $index }}.quantity" step="0.1"
                                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @endif
                    </td>
                    <td class="border-dashed border-t border-gray-200">
                    ...
                    <td class="border-dashed border-t border-gray-200">
                        ...
                        @else
                            <input type="date"
                                wire:model.defer="stocks.{{ $index }}.date_buy"
                                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @endif
                    </td>
                    <td class="border-dashed border-t border-gray-200">
            ...
            @empty
                <tr>
                    <td colspan="8" class="border-dashed border-t border-gray-200 px-3">
