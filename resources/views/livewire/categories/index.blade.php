<div class="py-12" x-data="{
    ...
    <div class="overflow-x-auto relative sm:rounded-lg">
        <div class="w-full max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <table class="w-full mx-auto sm:px-6 lg:px-8 text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <form wire:submit.prevent="store" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    <button type="submit" @click="open = false"
                        class="text-white bg-[#212121] hover:bg-[#515151]/90 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Tambah</button>
                </div>
            </form>
        </div>
